...
1.  **Создание персонажей**: Генерация ключевых персонажей с именами, внешностью, характером и мотивацией, строго соответствующими заданному сюжету - 3 агента.
![](pictures/character_creator_block.png)
2.  **Создание заклинаний**: Генерация уникальных заклинаний (или редких каноничных), которые будут играть роль в развитии сюжета - 3 агента.
![](pictures/spell_creator_block.png)
3.  **Создание зелий**: Аналогично, генерация зелий, интегрированных в историю - 3 агента.
...
12. **Формирование ответа**: Файл прикрепляется к последней ноде n8n. Логичным продолжением проекта была бы отправка файла в Телеграм-чат пользователю.
